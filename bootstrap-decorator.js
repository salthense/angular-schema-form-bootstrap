...
$templateCache.put("decorators/bootstrap/image.html","<div class=\"form-group {{::form.htmlClass}}\"><label class=\"control-label\" ng-class=\"{\'sr-only\': !showTitle(), \'{{form.labelHtmlClass}}\': true}\" for=\"{{::form.key.slice(-1)[0]}}\" data-trigger=\"hover\" placement=\"auto right\" data-content=\"{{::form.popover}}\" data-html=\"true\" data-container=\"body\">{{::form.title}} <span class=\"glyphicon glyphicon-info-sign\" ng-show=\"::form.popover\"></span></label> <a colorbox=\"\" class=\"image-lightbox\" ng-href=\"types/{{::schema.title}}/images/{{::form.file}}\"><img ng-src=\"types/{{::schema.title}}/images/thumbnail_{{form.file}}\"></a></div>");
$templateCache.put("decorators/bootstrap/label.html","<div class=\"{{::form.htmlClass}} schema-form-label\" ng-class=\"{{::form.ngClass}}\">{{::form.title}}</div>");
...
$templateCache.put("decorators/bootstrap/relation.html","<div class=\"schema-form-relation {{::form.outerClass}}\" relations:=\"\" {{record}}=\"\" ng-class=\"{{::form.ngClass}}\" sf-field-model=\"sf-relation\" sf-relation=\"\"><label class=\"control-label\" ng-show=\"::showTitle()\" data-trigger=\"hover\" placement=\"auto right\" data-content=\"{{::form.popover}}\" data-html=\"true\" data-container=\"body\">{{::form.title}} <span class=\"glyphicon glyphicon-info-sign\" ng-show=\"::form.popover\"></span></label><div ng-if=\"linkedSchemaTitle\" ng-include=\"\'types/\' + linkedSchemaTitle + \'/views/\' + form.template\"></div></div>");
...
$templateCache.put("decorators/bootstrap/table.html","<div><div class=\"help-block\" ng-show=\"::form.description\" ng-bind-html=\"::form.description\"></div><table class=\"table schema-form-table {{::form.htmlClass}}\" ng-class=\"{{::form.ngClass}}\"><caption ng-show=\"::showTitle()\">{{::form.title}}</caption><thead><tr><th ng-repeat=\"header in form.headers\">{{::header}}</th></tr></thead><tbody class=\"table-content\"></tbody></table></div>");
